...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ENVIRONMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_ENVIRONMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ENVIRONMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ENVIRONMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ENVIRONMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ENVIRONMENT actions', async () => {
      const expectedActions = [
        {
