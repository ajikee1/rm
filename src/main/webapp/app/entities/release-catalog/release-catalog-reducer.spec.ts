...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RELEASECATALOG_LIST actions', async () => {
    ...
    it('dispatches FETCH_RELEASECATALOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RELEASECATALOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RELEASECATALOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RELEASECATALOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RELEASECATALOG actions', async () => {
      const expectedActions = [
        {
