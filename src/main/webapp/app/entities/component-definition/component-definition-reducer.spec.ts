...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './component-definition.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPONENTDEFINITION_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPONENTDEFINITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPONENTDEFINITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPONENTDEFINITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPONENTDEFINITION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPONENTDEFINITION actions', async () => {
      const expectedActions = [
        {
