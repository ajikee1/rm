...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './deployment-kind-catalog.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEPLOYMENTKINDCATALOG_LIST actions', async () => {
    ...
    it('dispatches FETCH_DEPLOYMENTKINDCATALOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEPLOYMENTKINDCATALOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEPLOYMENTKINDCATALOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEPLOYMENTKINDCATALOG actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEPLOYMENTKINDCATALOG actions', async () => {
      const expectedActions = [
        {
