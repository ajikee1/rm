...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPONENTSET_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPONENTSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPONENTSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPONENTSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPONENTSET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPONENTSET actions', async () => {
      const expectedActions = [
        {
