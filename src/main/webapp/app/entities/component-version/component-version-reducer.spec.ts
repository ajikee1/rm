...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './component-version.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPONENTVERSION_LIST actions', async () => {
    ...
    it('dispatches FETCH_COMPONENTVERSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COMPONENTVERSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COMPONENTVERSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COMPONENTVERSION actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COMPONENTVERSION actions', async () => {
      const expectedActions = [
        {
